...
OUTPUTPATH="/home/mypc/Documents/otras/"

pfw N=2000 $NAME".msf"  > "pfw"$NAME.msf
pfmake -c "pfw"$NAME".msf" "blosum45.cmp" > $NAME".prf"
pfsearch -f $NAME".prf" $path"pdb_seqres.txt" > "searchCircularResults_"$NAME
/home/lhirsh/Documents/scaling/autoscaling.pl $NAME".prf" > "new"$NAME".prf"
pfsearch -f "new"$NAME".prf" $path"pdb_seqres.txt" > "autoscalingsearchCircularResults_"$NAME
